...
1. [Goal Setting & Tracking](#1-goal-setting--tracking)
2. [Training Log / Journal](#2-training-log--journal)
3. [Warm-up Generator](#3-warm-up-generator)
4. [Progress Charts & Analytics](#4-progress-charts--analytics)
5. [WOD Generator / Random Workout](#5-wod-generator--random-workout)
6. [Equipment Filter](#6-equipment-filter)
7. [Body Metrics Tracking](#7-body-metrics-tracking)
8. [Movement Substitutions](#8-movement-substitutions)
...
## 5. WOD Generator / Random Workout
...
- **Filter Options**:
  ...
  - Equipment filter (see Feature #6)
...
|----------|---------|------------|-------|
| 1 | Goal Setting & Tracking | Medium | High |
| 2 | Training Log / Journal | Medium-High | Medium |
| 3 | Warm-up Generator | Medium | Medium |
| 4 | WOD Generator | Small-Medium | High |
| 5 | Equipment Filter | Small + Data | High |
| 6 | Progress Charts | Medium | High |
| 7 | Body Metrics | Small-Medium | Medium |
| 8 | Movement Substitutions | Small + Data | Medium |
