...
export const DatePicker = ({ value, onChange, maxDate = new Date() }: DatePickerProps) => {
    ...
    <div className="relative">
      ...
      {isOpen && (
        <>
          ...
          {/* Calendar */}
          <div className="absolute left-0 right-0 mt-2 z-50 bg-[var(--color-surface-elevated)] border border-[var(--color-border)] rounded-xl shadow-xl overflow-hidden animate-fade-in">
            {/* Header */}
